...
?>
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"><i class="fa fa-bullhorn"></i> <?php _e('Marketing Data', 'cf7-salesforce'); ?></div>
...
<p><?php _e('Need Marketing Insight? ,','cf7-salesforce')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php _e('Go Pro!','cf7-salesforce')?></a></p>
</div>
 <?php
 }else{
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php _e('No Information Available','cf7-salesforce')?></h3>
   <?php
}
 }
?>
